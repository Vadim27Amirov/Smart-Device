...
/* harmony import */ var _modules_modals_adaptive__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/modals/adaptive */ "./js/modules/modals/adaptive.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var accordionTitles = document.querySelectorAll('[data-accordion] button');
  ...
  var initAccordion = function initAccordion() {
    ...
    if (accordionTitles.length > 0) {
      accordionTitles.forEach(function (accordeonTitle) {
        accordeonTitle.addEventListener('click', function (evt) {
          if (evt.target.classList.contains('is-open')) {
            evt.target.classList.remove('is-open');
          } else {
            var _iterator2 = _createForOfIteratorHelper(accordionTitles),
              _step2;
            try {
  ...
  Object(_modules_modals_adaptive__WEBPACK_IMPORTED_MODULE_3__["breakpointCheckerDesktop"])();
...
/***/ "./js/modules/modals/adaptive.js":
/*!***************************************!*\
  !*** ./js/modules/modals/adaptive.js ***!
  \***************************************/
/*! exports provided: breakpointCheckerDesktop */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "breakpointCheckerDesktop", function() { return breakpointCheckerDesktop; });
var cardTitle = document.querySelector('[data-products="link"] h3');
var breakpointDesktop = window.matchMedia('(min-width:1024px)');
var breakpointCheckerDesktop = function breakpointCheckerDesktop() {
...
var feedbackModalName = document.querySelector('#modal-name');
